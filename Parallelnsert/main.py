...
fakewords = ["vpn", "log", "security", "blank", "calling", "internet", "python", "java", "mssql", "clickhouse", "oracle", "various", "bruteforce", "ddos", "chart", "truva", "trojan", "resident" ]
fakewords1 = ["mysql", "generator", "iterator", "syntax", "authentication failure", "SSL", "TLS", "Time", "ındex", ]
fakewords2 = ["failed logins ", "security policy", "rootkit", "suspiciousfilemodification", "Virus", "security", "log", "keylogger", "string", "reload", "betaversion", "avira", "mcafee", "ıntel"]
fakewords3 = ["local", "injection", "server", "Malware", "Access", "report", "created", "network", "quarantined", "shutdown", "textbox", "shutdown", "asp.net", "format", "repistory", "pull", "push"]
fakewords4 = ["selected", "event", "domain", "session", "ıd", "framework", "mysql", "exfiltration", "download", "for", "hire", "bigdata", "inheritence", "abstraction", "polymorphism", "chipsecurity"]
true = ["True", "False"]
